...
/*   Updated: 2024/04/14 13:07:15 by wouhliss         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline void	ft_interact(t_game *g)
{
	...
	if (g->p.looking)
	{
		...
		if (g->map.map[g->p.look_pos.y][g->p.look_pos.x] == '1' && g->p.look_pos.y > 0 && g->p.look_pos.x > 0 && g->p.look_pos.y < g->length - 1 && g->p.look_pos.x < g->width - 1)
